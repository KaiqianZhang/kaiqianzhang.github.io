...
<div class='pipe-anim'>
    <div class='panels'>
        <div class='panel'>
            <svg viewBox='0 0 256 188' role='img'
                ...
                <line class='meanline ln-meanline' x1='6' y1='79.25' x2='250' y2='79.25'/>
                <text class='cap' x='6' y='180'>subtract &#956;, then divide by &#963;</text>
            </svg>
        </div>
        <div class='panel'>
            <svg viewBox='0 0 256 188' role='img'
                ...
                <line class='meanline rms-meanline' x1='6' y1='79.25' x2='250' y2='79.25'/>
                <text class='cap' x='6' y='180'>divide by RMS &#8212; and that is all</text>
            </svg>
        </div>
    </div>
    <div class='caption'>
