...
<div class='roadmap'>
    <svg viewBox='0 0 760 498' role='img' aria-label='Roadmap of attention: a fix for a bottleneck in 2014, a simpler score in 2015, the recurrence dropped in 2017, and the transformer everywhere after.'>
      <path class='spine' d='M99.4,248.8 Q380.2,248.2 660.9,248.4'/>
      <path class='head' d='M179.8,248.7 Q192.8,248.5 205.8,248.7'/>
      <path class='head' d='M179.7,249.4 Q193.1,248.5 206.5,248.7'/>
      <path class='head' d='M206.4,248.6 Q204.0,250.5 201.1,251.7'/>
      <path class='head' d='M205.3,248.6 Q203.1,247.2 200.7,246.4'/>
      <text class='why' x='193.0' y='220.0'>the scoring network</text>
      <text class='why' x='193.0' y='238.0'>was extra machinery</text>
      <path class='head' d='M366.5,249.4 Q379.4,249.7 392.4,249.0'/>
      <path class='head' d='M367.3,249.2 Q379.9,248.6 392.5,248.4'/>
      <path class='head' d='M393.7,248.9 Q391.1,250.8 388.4,252.7'/>
      <path class='head' d='M393.1,248.5 Q390.4,246.9 387.8,245.3'/>
      <text class='why' x='380.0' y='202.0'>attention was fine;</text>
      <text class='why' x='380.0' y='220.0'>the recurrence was</text>
      <text class='why' x='380.0' y='238.0'>not</text>
      <path class='head' d='M554.2,248.6 Q567.4,249.5 580.7,249.3'/>
      <path class='head' d='M553.7,249.4 Q567.0,249.6 580.3,249.6'/>
      <path class='head' d='M580.1,248.6 Q577.1,250.4 574.3,252.3'/>
      <path class='head' d='M579.7,248.6 Q577.7,246.9 575.4,245.5'/>
      <text class='why' x='567.0' y='220.0'>quadratic cost, and a</text>
      <text class='why' x='567.0' y='238.0'>cache to feed</text>
      <g class='stop'>
        <rect class='hit' x='15.0' y='0.0' width='356.0' height='175.0'/>
        <path class='stem' d='M99.7,174.9 Q99.6,211.7 99.3,248.6'/>
        <circle class='dot' cx='99.5' cy='249.0' r='5'/>
        <path class='box' d='M23.5,-0.5 Q193.0,0.1 362.6,-0.5 Q371.6,-0.5 371.6,8.5 Q371.4,87.3 371.6,166.1 Q371.6,175.1 362.6,175.1 Q193.0,175.6 23.5,175.1 Q14.5,175.1 14.5,166.1 Q14.2,87.3 14.5,8.5 Q14.5,-0.5 23.5,-0.5'/>
        <path class='box' d='M23.6,0.8 Q192.8,1.6 362.1,0.8 Q371.1,0.8 371.1,9.8 Q371.3,87.6 371.1,165.3 Q371.1,174.3 362.1,174.3 Q192.8,173.6 23.6,174.3 Q14.6,174.3 14.6,165.3 Q13.9,87.6 14.6,9.8 Q14.6,0.8 23.6,0.8'/>
        <text class='yr' x='29.0' y='21.0'>2014</text>
        <text class='stage' x='29.0' y='45.0'>a fix for a bottleneck</text>
        <circle class='bul' cx='33.0' cy='63.0' r='2'/>
        <text class='body' x='42.0' y='67.0'>one fixed vector could not hold a long</text>
        <text class='body' x='42.0' y='86.5'>sentence</text>
        <circle class='bul' cx='33.0' cy='102.0' r='2'/>
        <text class='body' x='42.0' y='106.0'>let the decoder look back at every</text>
        <text class='body' x='42.0' y='125.5'>source word</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='15.0' y='323.0' width='356.0' height='175.0'/>
        <path class='stem' d='M287.2,322.6 Q287.0,286.0 285.9,249.3'/>
        <circle class='dot' cx='286.5' cy='249.0' r='5'/>
        <path class='box' d='M23.5,323.4 Q192.9,323.4 362.4,323.4 Q371.4,323.4 371.4,332.4 Q370.6,410.9 371.4,489.4 Q371.4,498.4 362.4,498.4 Q192.9,499.4 23.5,498.4 Q14.5,498.4 14.5,489.4 Q13.7,410.9 14.5,332.4 Q14.5,323.4 23.5,323.4'/>
        <path class='box' d='M24.1,322.8 Q192.8,323.5 361.6,322.8 Q370.6,322.8 370.6,331.8 Q370.1,410.2 370.6,488.7 Q370.6,497.7 361.6,497.7 Q192.8,497.1 24.1,497.7 Q15.1,497.7 15.1,488.7 Q14.4,410.2 15.1,331.8 Q15.1,322.8 24.1,322.8'/>
        <text class='yr' x='29.0' y='344.0'>2015</text>
        <text class='stage' x='29.0' y='368.0'>the score gets simpler</text>
        <circle class='bul' cx='33.0' cy='386.0' r='2'/>
        <text class='body' x='42.0' y='390.0'>replace the alignment network with a dot</text>
        <text class='body' x='42.0' y='409.5'>product</text>
        <circle class='bul' cx='33.0' cy='425.0' r='2'/>
        <text class='body' x='42.0' y='429.0'>cheaper, and the form still used today</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='389.0' y='0.0' width='356.0' height='175.0'/>
        <path class='stem' d='M473.2,174.8 Q474.1,211.6 473.9,248.5'/>
        <circle class='dot' cx='473.5' cy='249.0' r='5'/>
        <path class='box' d='M397.4,-0.7 Q566.9,-0.3 736.4,-0.7 Q745.4,-0.7 745.4,8.3 Q744.4,87.5 745.4,166.7 Q745.4,175.7 736.4,175.7 Q566.9,175.4 397.4,175.7 Q388.4,175.7 388.4,166.7 Q389.0,87.5 388.4,8.3 Q388.4,-0.7 397.4,-0.7'/>
        <path class='box' d='M397.6,0.8 Q566.7,-0.1 735.8,0.8 Q744.8,0.8 744.8,9.8 Q745.1,87.9 744.8,166.1 Q744.8,175.1 735.8,175.1 Q566.7,174.6 397.6,175.1 Q388.6,175.1 388.6,166.1 Q389.1,87.9 388.6,9.8 Q388.6,0.8 397.6,0.8'/>
        <text class='yr' x='403.0' y='21.0'>2017</text>
        <text class='stage' x='403.0' y='45.0'>drop the recurrence</text>
        <circle class='bul' cx='407.0' cy='63.0' r='2'/>
        <text class='body' x='416.0' y='67.0'>keep only attention, pointed at the</text>
        <text class='body' x='416.0' y='86.5'>sequence itself</text>
        <circle class='bul' cx='407.0' cy='102.0' r='2'/>
        <text class='body' x='416.0' y='106.0'>multiple heads, and the square-root</text>
        <text class='body' x='416.0' y='125.5'>scaling</text>
        <circle class='bul' cx='407.0' cy='141.0' r='2'/>
        <text class='body' x='416.0' y='145.0'>all positions at once, so training</text>
        <text class='body' x='416.0' y='164.5'>parallelizes</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='389.0' y='323.0' width='356.0' height='175.0'/>
        <path class='stem' d='M661.0,323.2 Q660.6,285.9 660.5,248.6'/>
        <circle class='dot' cx='660.5' cy='249.0' r='5'/>
        <path class='box' d='M398.3,322.9 Q567.2,323.5 736.0,322.9 Q745.0,322.9 745.0,331.9 Q745.7,410.7 745.0,489.6 Q745.0,498.6 736.0,498.6 Q567.2,497.9 398.3,498.6 Q389.3,498.6 389.3,489.6 Q389.8,410.7 389.3,331.9 Q389.3,322.9 398.3,322.9'/>
        <path class='box' d='M398.2,322.8 Q567.3,322.9 736.4,322.8 Q745.4,322.8 745.4,331.8 Q745.4,410.3 745.4,488.7 Q745.4,497.7 736.4,497.7 Q567.3,497.6 398.2,497.7 Q389.2,497.7 389.2,488.7 Q388.5,410.3 389.2,331.8 Q389.2,322.8 398.2,322.8'/>
        <text class='yr' x='403.0' y='344.0'>2018-</text>
        <text class='stage' x='403.0' y='368.0'>everything is a transformer</text>
        <circle class='bul' cx='407.0' cy='386.0' r='2'/>
        <text class='body' x='416.0' y='390.0'>BERT and GPT build on it</text>
        <circle class='bul' cx='407.0' cy='405.5' r='2'/>
        <text class='body' x='416.0' y='409.5'>by the 2020s hybrids swap some attention</text>
        <text class='body' x='416.0' y='429.0'>back out</text>
      </g>
    </svg>
</div>
...
<div class='knob'>
    <svg viewBox='0 0 720 264' id='qkv-svg' role='img'
...
(function () {
  ...
  function draw() {
    ...
    s += "<text class='gl' x='" + X0 + "' y='236'>each word's key vector \u2014 these belong " +
         "to the words,</text>";
    s += "<text class='gl' x='" + X0 + "' y='254'>so they do not change when you pick a " +
         "different asker</text>";
...
I would hold on to that pairing — **large logits into a softmax means no
gradient** — because it is much more general than this one constant. It is why
temperature matters at sampling time, why people watch attention entropy
during training and call its collapse a failure mode, and why the scaling
rules for very wide models are written the way they are. The square root in
the formula is the first place a researcher meets the problem, not the last.
...
length — and the [memory in particular](/blog/2026/08/12/kv-cache-costs/) is
