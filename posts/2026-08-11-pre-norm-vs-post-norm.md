...
<div class='roadmap'>
    <svg viewBox='0 0 760 277' role='img' aria-label='Roadmap of normalizer placement: warm-up appears in 2017, the rearrangement spreads in 2018 to 2019, Xiong et al. explain it in 2020, pre-norm is the default after.'>
      <path class='spine' d='M99.4,138.9 Q380.1,139.7 660.8,138.8'/>
      <path class='head' d='M179.8,138.0 Q192.5,137.9 205.3,138.4'/>
      <path class='head' d='M180.0,138.8 Q193.0,138.9 206.0,138.5'/>
      <path class='head' d='M205.7,138.8 Q203.7,140.6 201.5,142.3'/>
      <path class='head' d='M205.4,138.1 Q202.9,136.9 200.3,136.1'/>
      <text class='why' x='193.0' y='114.5'>nobody could say what it</text>
      <text class='why' x='193.0' y='127.5'>was for</text>
      <path class='head' d='M366.6,138.4 Q379.7,138.7 392.7,138.4'/>
      <path class='head' d='M366.4,138.0 Q379.7,138.7 393.0,138.9'/>
      <path class='head' d='M393.3,138.0 Q390.2,139.4 387.3,141.3'/>
      <path class='head' d='M392.7,138.4 Q390.1,137.5 387.8,136.0'/>
      <text class='why' x='380.0' y='127.5'>it worked, unexplained</text>
      <path class='head' d='M554.2,138.6 Q567.4,138.7 580.5,138.5'/>
      <path class='head' d='M553.8,138.6 Q566.9,138.3 580.1,138.4'/>
      <path class='head' d='M579.5,138.7 Q576.7,139.8 574.4,141.7'/>
      <path class='head' d='M580.2,138.1 Q578.0,136.6 575.4,135.7'/>
      <text class='why' x='567.0' y='114.5'>a folk remedy becomes a</text>
      <text class='why' x='567.0' y='127.5'>rule</text>
      <g class='stop'>
        <rect class='hit' x='15.0' y='0.0' width='356.0' height='92.5'/>
        <path class='stem' d='M99.0,91.9 Q99.4,115.2 98.9,138.6'/>
        <circle class='dot' cx='99.5' cy='138.5' r='5'/>
        <path class='box' d='M23.1,-0.1 Q192.5,-1.0 361.9,-0.1 Q370.9,-0.1 370.9,8.9 Q370.8,45.9 370.9,83.0 Q370.9,92.0 361.9,92.0 Q192.5,91.4 23.1,92.0 Q14.1,92.0 14.1,83.0 Q13.2,45.9 14.1,8.9 Q14.1,-0.1 23.1,-0.1'/>
        <path class='box' d='M23.8,-0.5 Q193.1,0.2 362.4,-0.5 Q371.4,-0.5 371.4,8.5 Q371.8,45.9 371.4,83.3 Q371.4,92.3 362.4,92.3 Q193.1,92.1 23.8,92.3 Q14.8,92.3 14.8,83.3 Q14.3,45.9 14.8,8.5 Q14.8,-0.5 23.8,-0.5'/>
        ...
        <text class='body' x='42.0' y='56.0'>the Transformer needs a ramped learning rate</text>
        <circle class='bul' cx='33.0' cy='67.5' r='2'/>
        <text class='body' x='42.0' y='71.5'>4,000 steps, with no reason given</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='15.0' y='184.5' width='356.0' height='92.5'/>
        <path class='stem' d='M286.0,183.8 Q286.0,161.2 286.9,138.5'/>
        <circle class='dot' cx='286.5' cy='138.5' r='5'/>
        <path class='box' d='M24.7,185.2 Q193.3,185.5 361.9,185.2 Q370.9,185.2 370.9,194.2 Q370.3,231.2 370.9,268.2 Q370.9,277.2 361.9,277.2 Q193.3,276.9 24.7,277.2 Q15.7,277.2 15.7,268.2 Q16.1,231.2 15.7,194.2 Q15.7,185.2 24.7,185.2'/>
        <path class='box' d='M23.3,184.3 Q192.7,184.5 362.1,184.3 Q371.1,184.3 371.1,193.3 Q370.3,231.0 371.1,268.7 Q371.1,277.7 362.1,277.7 Q192.7,276.8 23.3,277.7 Q14.3,277.7 14.3,268.7 Q14.0,231.0 14.3,193.3 Q14.3,184.3 23.3,184.3'/>
        <text class='yr' x='29.0' y='203.5'>2018-19</text>
        <text class='stage' x='29.0' y='221.5'>the block is rearranged</text>
        <circle class='bul' cx='33.0' cy='236.5' r='2'/>
        <text class='body' x='42.0' y='240.5'>normalize before the sublayer, not after</text>
        <circle class='bul' cx='33.0' cy='252.0' r='2'/>
        <text class='body' x='42.0' y='256.0'>training gets stable; the folklore spreads</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='389.0' y='0.0' width='356.0' height='92.5'/>
        <path class='stem' d='M473.1,93.1 Q473.9,116.0 474.1,138.9'/>
        <circle class='dot' cx='473.5' cy='138.5' r='5'/>
        <path class='box' d='M397.4,-0.7 Q566.7,0.1 736.1,-0.7 Q745.1,-0.7 745.1,8.3 Q745.7,46.1 745.1,83.9 Q745.1,92.9 736.1,92.9 Q566.7,92.8 397.4,92.9 Q388.4,92.9 388.4,83.9 Q388.2,46.1 388.4,8.3 Q388.4,-0.7 397.4,-0.7'/>
        <path class='box' d='M397.8,0.1 Q566.8,0.2 735.8,0.1 Q744.8,0.1 744.8,9.1 Q744.2,46.7 744.8,84.4 Q744.8,93.4 735.8,93.4 Q566.8,93.2 397.8,93.4 Q388.8,93.4 388.8,84.4 Q388.6,46.7 388.8,9.1 Q388.8,0.1 397.8,0.1'/>
        ...
        <text class='body' x='416.0' y='71.5'>pre-norm gradients do not</text>
        <circle class='bul' cx='407.0' cy='83.0' r='2'/>
        <text class='body' x='416.0' y='87.0'>so the warm-up was patching a real problem</text>
      </g>
      <g class='stop'>
        <rect class='hit' x='389.0' y='184.5' width='356.0' height='92.5'/>
        <path class='stem' d='M660.7,184.3 Q660.4,161.7 660.4,139.1'/>
        <circle class='dot' cx='660.5' cy='138.5' r='5'/>
        <path class='box' d='M397.2,184.6 Q566.8,184.3 736.4,184.6 Q745.4,184.6 745.4,193.6 Q745.5,230.5 745.4,267.5 Q745.4,276.5 736.4,276.5 Q566.8,275.8 397.2,276.5 Q388.2,276.5 388.2,267.5 Q387.9,230.5 388.2,193.6 Q388.2,184.6 397.2,184.6'/>
        <path class='box' d='M398.5,185.4 Q566.9,184.9 735.3,185.4 Q744.3,185.4 744.3,194.4 Q744.3,231.3 744.3,268.3 Q744.3,277.3 735.3,277.3 Q566.9,277.0 398.5,277.3 Q389.5,277.3 389.5,268.3 Q389.9,231.3 389.5,194.4 Q389.5,185.4 398.5,185.4'/>
        <text class='yr' x='403.0' y='203.5'>2020-</text>
        <text class='stage' x='403.0' y='221.5'>pre-norm by default</text>
        <circle class='bul' cx='407.0' cy='236.5' r='2'/>
        <text class='body' x='416.0' y='240.5'>GPT-3, LLaMA, PaLM and the rest adopt it</text>
        <circle class='bul' cx='407.0' cy='252.0' r='2'/>
        <text class='body' x='416.0' y='256.0'>post-norm survives in a few places</text>
      </g>
    </svg>
</div>
